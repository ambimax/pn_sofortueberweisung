 ...
 *
 * $Date: 2012-05-31 13:10:37 +0200 (Do, 31. Mai 2012) $
 * @version SofortLib 1.5.0  $Id: sofortLib_http.inc.php 4300 2012-05-31 11:10:37Z niehoff $
	...
	public function getHttpCode() {
		switch ($this->httpStatus) {
			...
			case(500):
				...
				break;
			default:
				return array('code' => 404, 'message' => $this->_xmlError($this->httpStatus, 'URL not found '.$this->url), 'response' => $this->_response);
				break;
		}
		
		return array('code' => 404, 'message' => $this->_xmlError($this->httpStatus, 'Something went wrong'));
	}
