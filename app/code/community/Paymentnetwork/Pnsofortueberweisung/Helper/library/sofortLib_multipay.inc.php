 ...
 *
 * $Date: 2012-08-01 11:05:46 +0200 (Mi, 01. Aug 2012) $
 * @version SofortLib 1.5.0  $Id: sofortLib_multipay.inc.php 4972 2012-08-01 09:05:46Z dehn $
...
class SofortLib_Multipay extends SofortLib_Abstract {
	 ...
	 * @return SofortLib_Multipay $this
	 */
	public function setSofortrechnungInvoiceAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE', $company = '') {
		...
		$this->_parameters['sr']['invoice_address']['company'] = $company;
		return $this;
	}
	 ...
	 * @return SofortLib_Multipay $this
	 */
	public function setSofortrechnungShippingAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE', $company = '') {
		...
		$this->_parameters['sr']['shipping_address']['company'] = $company;
		return $this;
	}
