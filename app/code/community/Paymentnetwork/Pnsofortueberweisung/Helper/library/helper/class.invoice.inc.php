 ...
 *
 * $Date: 2012-06-05 15:38:04 +0200 (Di, 05. Jun 2012) $
 * @version $Id: class.invoice.inc.php 4344 2012-06-05 13:38:04Z dehn $
 * @package sofortLib
...
class PnagInvoice extends PnagAbstractDocument {
	...
	private function _setupConfirmSr() {
		$SofortLib_ConfirmSr = new SofortLib_ConfirmSr($this->_configKey, $this->_apiUrl);
	 ...
	 * @public
	 */
	public function confirmInvoice($transactionId = '') {
		if ($transactionId != '') {
			$this->_transactionId = $transactionId;
			$this->ConfirmSr = $this->_setupConfirmSr();
		}
	 ...
	 * return array
	 */
	public function updateInvoice($transactionId, $items, $comment) {
		if ($transactionId != '') {
			$this->_transactionId = $transactionId;
			$this->ConfirmSr = $this->_setupConfirmSr();
		}
		...
		if ($this->ConfirmSr != null) {
			$this->ConfirmSr->setComment($comment);
			$this->ConfirmSr->updateCart($items);
			$this->ConfirmSr->sendRequest();
			$this->SofortLib_TransactionData = $this->_setupTransactionData();
			return $this->getErrors();
		}
	 ...
	 * @param $country
	 */
	public function addShippingAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE', $nameAdditive = '') {
		$this->SofortLib_Multipay->setSofortrechnungShippingAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country, $nameAdditive);
	}
	 ...
	 * @deprecated
	 */
	public function addShippingAddresss($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE') {
		$this->SofortLib_Multipay->setSofortrechnungShippingAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country);
	}
	 ...
	 * @param $country
	 */
	public function addInvoiceAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country = 'DE', $nameAdditive = '') {
		$this->SofortLib_Multipay->setSofortrechnungInvoiceAddress($firstname, $lastname, $street, $streetNumber, $zipcode, $city, $salutation, $country, $nameAdditive);
	}
	
	
	public function setNameAdditive($nameAdditive) {
		$this->SofortLib_Multipay->setNameAdditive($nameAdditive);
	}
	...
	*/
	...
	public function getInvoice() {
		...
		echo file_get_contents($this->_invoiceUrl);
		return true;
	}
	...
	public function enableLog() {
		(is_a($this->SofortLib_Multipay, 'SofortLib')) ? $this->SofortLib_Multipay->enableLog() : '';
		(is_a($this->SofortLib_TransactionData, 'SofortLib')) ? $this->SofortLib_TransactionData->enableLog() : '';
	...
	public function disableLog() {
		(is_a($this->SofortLib_Multipay, 'SofortLib')) ? $this->SofortLib_Multipay->disableLog() : '';
		(is_a($this->SofortLib_TransactionData, 'SofortLib')) ? $this->SofortLib_TransactionData->disableLog() : '';
